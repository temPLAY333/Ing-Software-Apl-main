...
describe('Client e2e test', () => {
  ...
  const clientSample = { firstName: 'Chadd', lastName: 'Heaney' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      cy.get(`[data-cy="firstName"]`).type('Emery');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Emery');

      cy.get(`[data-cy="lastName"]`).type('Jaskolski');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Jaskolski');

      cy.get(`[data-cy="email"]`).type('Devan78@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Devan78@gmail.com');

      cy.get(`[data-cy="address"]`).type('atop');
      cy.get(`[data-cy="address"]`).should('have.value', 'atop');

      cy.get(`[data-cy="phone"]`).type('1-296-380-1274 x2545');
      cy.get(`[data-cy="phone"]`).should('have.value', '1-296-380-1274 x2545');
