...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0f6f2e05-3a7c-4996-ad90-f0b813cd3323' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('cc712edc-3b3f-45eb-9806-9514cd3a3330');
      cy.get(`[data-cy="name"]`).should('have.value', 'cc712edc-3b3f-45eb-9806-9514cd3a3330');
