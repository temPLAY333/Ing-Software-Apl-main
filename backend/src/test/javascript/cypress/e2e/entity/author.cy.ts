...
describe('Author e2e test', () => {
  ...
  const authorSample = { firstName: 'Lonnie', lastName: 'Lind' };
  ...
  describe('new Author page', () => {
    ...
    it('should create an instance of Author', () => {
      cy.get(`[data-cy="firstName"]`).type('Brielle');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Brielle');

      cy.get(`[data-cy="lastName"]`).type('Stroman');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Stroman');
